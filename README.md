...
~~~php
composer require houjit021/thinkphp-jump
~~~
...
return[
    // 默认跳转页面对应的模板文件
    'dispatch_success_tmpl' => app()->getRootPath().'/vendor/houjit021/thinkphp-jump/src/tpl/dispatch_jump.tpl',
    'dispatch_error_tmpl'   => app()->getRootPath().'/vendor/houjit021/thinkphp-jump/src/tpl/dispatch_jump.tpl',
];
~~~

## 用法示例

使用 use \houjit021\think\Jump; 
